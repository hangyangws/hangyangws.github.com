...
看图说话「原点在左上角」：
![svg-coordinate](svg-coordinate.png)
...
动画理解：  
![viewBox-1](viewBox-1.png)  
![viewBox-2](viewBox-2.gif)
...
![svg-animate-attr](svg-animate-attr.jpg)
